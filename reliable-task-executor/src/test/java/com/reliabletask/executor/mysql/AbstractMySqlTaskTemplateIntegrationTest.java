...
@SpringBootTest(classes = AbstractMySqlTaskTemplateIntegrationTest.TestApplication.class)
abstract class AbstractMySqlTaskTemplateIntegrationTest {
    ...
    @Autowired
    protected TransactionAwareTaskTemplate taskTemplate;
    ...
    private static void registerShutdownHook() {
        ...
        }, "reliable-task-executor-mysql-it-shutdown"));
    ...
    static class TestApplication {
        ...
        @Bean
        TransactionAwareTaskTemplate transactionAwareTaskTemplate(MyBatisTaskStore taskStore) {
            return new TransactionAwareTaskTemplate(taskStore);
        }
    }
}
